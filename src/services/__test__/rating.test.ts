...
describe('Rating Service', () => {
  ...
  describe('Get rating based on swell period', () => {
    it('should get a rating of a 1 for a period of 5 seconds', () => {
      const rating = defaultRating.getRatingForSwellPeriod(5);
      expect(rating).toBe(1);
    });

    it('should get a rating of a 2 for a period of 9 seconds', () => {
      const rating = defaultRating.getRatingForSwellPeriod(9);
      expect(rating).toBe(2);
    });

    it('should get a rating of a 4 for a period of 12 seconds', () => {
      const rating = defaultRating.getRatingForSwellPeriod(12);
      expect(rating).toBe(4);
    });

    it('should get a rating of a 5 for a period of 16 seconds', () => {
  ...
  describe('Get rating based on swell height', () => {
    ...
    it('should get rating 3 waist high swell', () => {
      const rating = defaultRating.getRatingforSwellSize(1.5);
      expect(rating).toBe(3);
    });

    it('should get rating 5 for less than ankle to knee high swell', () => {
